...
window_canvas = Canvas(window, height=768, width=1457)


main_canvas = Canvas(window_canvas, height=637, width=1457, background="bisque")
blur_image = ImageTk.PhotoImage(file=r"image\blur.png")
main_canvas.create_image(637, 273, image=blur_image)
icon_image = PhotoImage(file=r"image\ecology.png")
icon_image = icon_image.subsample(10, 10)
main_canvas.create_image(137, 64, image=icon_image)
window.iconphoto(FALSE, icon_image)

rectangle = main_canvas.create_rectangle(1084, 173, 1320, 583, outline="#C0392B", width=3)

title = main_canvas.create_text(528, 68, text=trans_array[0], font=('monospace', 37), fill="#F7DC6F")
...
signin_button = main_canvas.create_window(1261, 68, window=signin_button, width=100)
...
help_button = window_canvas.create_window(1166, 68, window=help_button, width=100)

head_top = main_canvas.create_text(514, 209, text=trans_array[1], font=('Britannic Bold', 36),fill="#ffffff")
head_bottom = main_canvas.create_text(514, 255, text=trans_array[2]+'?', font=('Britannic Bold', 36),fill="#ffffff")
sub_head_one = main_canvas.create_text(501, 483, text=trans_array[3] + ' - ' + trans_array[4] + '.', font=('monospace', 20), fill="#ffffff")
sub_head_two = main_canvas.create_text(501, 528, text=trans_array[5]+' - '+trans_array[6]+'.', font=('monospace', 20), fill="#ffffff")

regfar_icon = PhotoImage(file=r"image\agriculture.png")
...
regfar_button = main_canvas.create_window(592, 360, window=regfar_button, width=200, height=50)

about_text = main_canvas.create_text(1205, 382, text= trans_array[7] + '\n' + trans_array[8] + '\n' + trans_array[9] +'.\n\n' +
                                        trans_array[10] + '\n' + trans_array[11] + '\n' + trans_array[12]  + '\n' + trans_array[13] +'.\n\n' +
                                        trans_array[14] +'\n' + trans_array[15] +'\n'+ trans_array[16] +'\n'+ trans_array[17] +'\n'+ trans_array[18] +'.\n\n' +
                                        trans_array[19] +'\n'+ trans_array[20] +'\n'+ trans_array[21] +'\n'+ trans_array[22], font=('monospace', 13), fill="#ffffff")


regbuy_icon = PhotoImage(file=r"image\shoppingcart.png")
...
regbuy_button = main_canvas.create_window(430, 360, window=regbuy_button, width=200, height=50)
...
dropdown = window_canvas.create_window(1200, 700, window=dropdown)
...
trans_butt.place(x=1155, y=660)
icon1 = PhotoImage(file=r"image\earth.png")
icon1 = icon1.subsample(5, 5)
img = Label(window, image=icon1)
img.place(x=637, y=660)
icon2 = PhotoImage(file=r"image\farmer.png")
icon2 = icon2.subsample(5, 5)
img = Label(window, image=icon2)
img.place(x=364, y=660)
icon3 = PhotoImage(file=r"image\growth.png")
icon3 = icon3.subsample(5, 5)
img = Label(window, image=icon3)
img.place(x=911, y=660)
window.mainloop()